(function (window, $, undefined) {
    ...
    $.Accordion.prototype = {
        ...
        _toggleItem: function ($item) {
            ...
            ($item.hasClass('accordion-open')) ? (this.current = -1, $content.stop(true, true).fadeOut(this.options.speed), $item.removeClass('accordion-open').stop().animate({
                height: $item.data('originalHeight')
            }, this.options.speed, this.options.easing)) : (this.current = $item.index(), $content.stop(true, true).fadeIn(this.options.speed), $item.addClass('accordion-open').stop().animate({
